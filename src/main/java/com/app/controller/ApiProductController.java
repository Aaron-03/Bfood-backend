...
public class ApiProductController {
	...
	// TODO: Hacer que Listeeeeee!!! MALDITA SEA >:v
	...
	public String lstProducts() throws JsonProcessingException {
		...
		ArrayList<Producto> products = (ArrayList<Producto>) productoService.read();
...
//	@GetMapping(path="/listbycategory", produces = "application/json", consumes = "application/json")
//	public String lstProductsByCategory(@Valid @RequestBody Categoria categoria) {
//		JSONObject jsonCategoria = new JSONObject(categoria.toString());
//		int dato_categoria = (int) jsonCategoria.get("categoria");
//		Producto p = ProductoService.getByCategory(dato_categoria);
//		return "";
//	}
}
